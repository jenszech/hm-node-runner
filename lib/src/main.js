...
function levelUpdate(level) {
    ...
    logger_1.logger.info('levelUpdate 1: ' + level.fheight + ' -> ' + (sysVar === null || sysVar === void 0 ? void 0 : sysVar.value));
    ccuApi_1.setValueToSysVar(sysVar, level.fheight);
    logger_1.logger.info('levelUpdate 2: ' + level.fheight + ' -> ' + (sysVar === null || sysVar === void 0 ? void 0 : sysVar.value));
    if (measure) {
        logger_1.logger.info('Export LevelData');
    ...
    logger_1.logger.info('levelUpdate 3: ' + level.fheight + ' -> ' + (sysVar2 === null || sysVar2 === void 0 ? void 0 : sysVar2.value));
}
