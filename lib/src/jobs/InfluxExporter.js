...
exports.getMeasureFromConfig = exports.exportVariable = exports.exportVariables = exports.exportValues = void 0;
...
function exportVariable2InfluxByType(variable, name, area) {
    if ((variable === null || variable === void 0 ? void 0 : variable.valueType) === homematic_js_xmlapi_1.ValueType.Number) {
        ...
        InfluxConnector_1.postToInflux(name, area, variable === null || variable === void 0 ? void 0 : variable.name, value);
    }
