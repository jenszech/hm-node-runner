...
exports.exportVariables = exports.exportValues = void 0;
...
function exportVariable2InfluxByType(variable, measure) {
    if ((variable === null || variable === void 0 ? void 0 : variable.valueType) === homematic_js_xmlapi_1.ValueType.Number) {
        var value = variable.value;
        InfluxConnector_1.postToInflux(measure.dataName, measure.area, variable === null || variable === void 0 ? void 0 : variable.name, value);
    }
