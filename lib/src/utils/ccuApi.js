...
exports.setValueToSysVar = exports.setValue = exports.setValuesList = exports.getCurrentStates = exports.getCurrentVariables = exports.getDeviceList = exports.getSysMgr = void 0;
...
function getJson() {
    ...
    try {
        for (var _b = (0, tslib_1.__values)(obj.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
            var sysVar = _c.value;
...
function setValuesList(valueMap) {
    var e_2, _a;
    try {
        for (var _b = (0, tslib_1.__values)(valueMap.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
            var value = _c.value;
...
function setValueToSysVar(sysvar, value) {
    if (sysvar) {
        sysvar.value = value;
        setValueToCCU(sysvar.iseId, value);
    }
}
exports.setValueToSysVar = setValueToSysVar;
